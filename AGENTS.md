...
- 当前真实进展：QA v5 完整旧 15 题独立核对为 7/10 完整有据交付、16/18 要点、10/11 条件、79/80 事实支持，检索充分性 10/10；据此修正生成与必要性判定。简介 v8 三篇均 insufficient_evidence，旧卡仍可读，新卡未记成功。最近 make check 为 335 项后端测试通过。确切版本、每轮失败及用量统一见 docs/verification-quality-v02.md，旧成绩不覆盖。
