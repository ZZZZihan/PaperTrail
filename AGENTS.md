...
- 当前真实进展：QA v7 evidence-qa-v7-query-term-coverage 根据真实合并检索遗漏加入最多两条词覆盖补充（仍12段/20k），实现前冻结同条件报告，349项make check通过，正在最终真实回归。QA v6全旧集独立6/10完整、13/18要点、9/11条件、82/82事实有据，旧失败保留。简介v9三篇中仅Reflexion发布，但独立自身引文支持仅5/8；ReAct/Toolformer未发布，本批无完整支持的新发布卡。工程完成仍pending，实际版本/分轮结果/用量统一见 docs/verification-quality-v02.md。
